...
public class Menu67ApiController {
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/getList", method=RequestMethod.POST)
	...
	@Transactional
	@ResponseBody
	@RequestMapping("/" + Menu67Controller.SUBMENU + "/deleteChecked")
	...
	@Transactional
	@ResponseBody
	@RequestMapping(value = "/" + Menu67Controller.SUBMENU + "/repay", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/checkDuplication", method = RequestMethod.GET)
	...
	@Transactional
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/update", method = RequestMethod.POST)
	...
	@Transactional
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/insert", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/getRepayDueList", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/insertTest", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/getYearDebtStat", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/getMonthDebtStat", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/getYearIntStat", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/" + Menu67Controller.SUBMENU + "/getDebtRatio", method = RequestMethod.POST)
