		...
		<div class="page-content">
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="row-fluid">
						<div class="span10">
							<form class="form-horizontal" id="form-sales" action="${pageContext.request.contextPath }/${menuInfo.mainMenuCode }/${menuInfo.subMenuCode }/list">
								<div class="span4">
									<div class="control-group">
										<label class="control-label form-field-1">년 월</label>
										<div class="row-fluid input-append span2">
											<input class="date-picker" id="cl-ym-date-picker" type="text" data-date-format="yyyy-mm" name="salesDate" value="${sales.salesDate }">
											<span class="add-on">
								...
								<div class="span6">
									<div class="control-group">
										...
										<div class="span8">
											<input type="text" id="customerCode" name="customerCode" style="width: 150px;" value="${sales.customerCode }">
				                            <div class="input-append">
					                              <input type="text" id="customerName" name="customerName" readonly style="width: 200px;" value="${sales.customerName }">
					                              <span class="add-on">
