						...
						<div class="span6">
							<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/${menuInfo.mainMenuCode }/${menuInfo.subMenuCode }/add">
								...
								<div class="control-group">
										<div style="float:left;width:50%">											
											...
											<div class="controls" style="width:90%">
												<input type="text" id="form-input-readonly" name="payDate" placeholder="날짜를 선택하세요"/> <i class="icon-calendar" id="calendar"></i>
											</div>
										</div>	
										<div style="float:left;width:50%">											
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="combine_no" name="combineNo" placeholder=""/>
									</div>
								</div>
							</form>
						</div>
							...
							<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/${menuInfo.mainMenuCode }/${menuInfo.subMenuCode }/add">
								...
								<div class="control-group">
                              		<div style="float:left">                                 
                               			...
                               			<div class="controls">
                                  			<input style="width:206px" type="text" id="form-field-1" name="acqPrice" placeholder="숫자만 입력하세요"/>
                                 		</div>
                             		</div>   
                              		<div style="float:left">                                 
                                 		<label style="width:60px; margin-right:20px;" class="control-label" for="form-field-1">층수</label>
                                 		<div style="width:205px; margin-left:10px" class="controls">
                                   			<input style="width:50px" type="text" id="form-field-1" name="acqPrice" placeholder="지상"/>
                                   			<input style="width:50px" type="text" id="form-field-1" name="acqPrice" placeholder="지하"/>
                                		</div>
                             		</div>   
                        		</div>
								<div class="control-group">
									...
									<div class="controls">
										<select class="chosen-select" id="cityAddr" name="cityAddr" data-placeholder="선택">
										</select>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span7" id="detailAddr" name="detailAddr" placeholder="내용을 입력하세요"/>
									</div>
								</div>
								<div class="control-group">
										<div style="float:left;width:50%">											
											...
											<div class="controls">
												<input readonly type="text" id="form-input-readonly" name="customerManager" placeholder=""/>
											</div>
										</div>	
										<div style="float:left;width:50%">											
											<label style="width:70px; margin-right:10px;" class="control-label" for="form-field-1">건물소유자</label>
											<input type="text" id="form-field-1" name="owner_name" placeholder="내용을 입력하세요"/>
										</div>	
								</div>
								<div class="control-group">
										<div style="float:left;width:50%">											
