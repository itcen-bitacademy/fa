						...
						<div class="span6"><!-- 차변 -->
							<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/${menuInfo.mainMenuCode }/${menuInfo.subMenuCode }/add">
								...
								<div class="control-group">
										...
										<div style="float:left;width:50%;">											
											<label style="margin-right: 20px" class="control-label" for="form-field-1">건물대분류명</label>
								...
								<div class="control-group">
										<div style="float:left;width:50%">											
											...
											<div class="controls">
												<input type="text" id="form-field-1" name="customer_name" placeholder="내용을 입력하세요"/>
											</div>
										</div>	
										<div style="float:left;width:50%">											
											<label class="control-label" for="form-field-1">거래처담당자명</label>
											<div class="controls">
												<input type="text" id="form-field-1" name="manager_name" placeholder="내용을 입력하세요"/>
											</div>
										</div>	
								</div>
								...
								<div class="control-group">
										<div style="float:left;">											
											...
											<div class="controls">
												<select style="width:205px;" class="chosen-select" id="form-field-select-1" name="sectionNo" data-placeholder="광역">
													<c:forEach items="${listMainMenu }" var="sectionVo">
														<option value="${sectionVo.no }">${sectionVo.name }</option>
													</c:forEach>
												</select>
										...
										<div style="float:left; margin-left:10px" class="controls">
											<select style="width:205px;" class="chosen-select" id="form-field-select-1" name="sectionNo" data-placeholder="시/군/구">
												<c:forEach items="${listMainMenu }" var="sectionVo">
													<option value="${sectionVo.no }">${sectionVo.name }</option>
												</c:forEach>
											</select>
										...
										<div style="float:left; margin-left:10px" class="controls">
											<select style="width:205px;" class="chosen-select" id="form-field-select-1" name="sectionNo" data-placeholder="읍/면/동">
												<c:forEach items="${listMainMenu }" var="sectionVo">
													<option value="${sectionVo.no }">${sectionVo.name }</option>
												</c:forEach>
											</select>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="area" name="area" placeholder="금액을 입력하세요"/>
						...
						<div class="span6"><!-- 대변 -->
							<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/${menuInfo.mainMenuCode }/${menuInfo.subMenuCode }/add">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="area" name="area" placeholder="숫자만 입력하세요"/>
								...
								<div class="control-group">
									<div class="controls">
										<input name="checkDel" type="checkbox" class="ace">
											<span class="lbl"> 삭제여부</span>
									</div>
								</div>
								<div class="control-group">
									<div class="span3" style="float:right;">
										<button class="btn btn-info btn-small" style="float:right;margin-right:20px;">상세조회</button>
									</div>
								</div>
							</form>
						</div><!-- 대변 span -->
							...
							<div class="control-group">
								<div class="controls">
									...
									<div class="span2" style="float:right">
										<input type="text" class="span12" id="form-field-1" name="search" placeholder="검색어를 입력하세요"/>
									</div>
								</div>
							</div>
						</form>
